...
@OpenAPIDefinition(
        info = @Info(
                title = "Microservicio Equipo - API",
                description = "API REST para la gestión de equipos en el gimnasio. " +
                        "Permite registrar, consultar, actualizar y eliminar equipos. " +
        ...
        servers = {
                ...
                @Server(
                        ...
                        url = "https://api-equipo.gimnasio.analisys.co"
                )
        },
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        .title("Microservicio Equipo - API")
                        .description("API REST completa para la gestión de equipos en el gimnasio. " +
                                "Incluye endpoints para registrar, consultar, actualizar y eliminar equipos. " +
