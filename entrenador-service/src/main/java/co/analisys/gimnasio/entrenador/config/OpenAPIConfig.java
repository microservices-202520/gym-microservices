...
@OpenAPIDefinition(
        info = @Info(
                title = "Microservicio Entrenador - API",
                description = "API REST para la gestión de entrenadores en el gimnasio. " +
                        "Permite agregar, consultar, actualizar y eliminar entrenadores. " +
        ...
        servers = {
                ...
                @Server(
                        ...
                        url = "https://api-entrenador.gimnasio.analisys.co"
                )
        },
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        .title("Microservicio Entrenador - API")
                        .description("API REST completa para la gestión de entrenadores en el gimnasio. " +
                                "Incluye endpoints para agregar, consultar, actualizar y eliminar entrenadores. " +
