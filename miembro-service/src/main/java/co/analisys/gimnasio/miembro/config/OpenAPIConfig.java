...
@OpenAPIDefinition(
        info = @Info(
                title = "Microservicio Miembro - API",
                description = "API REST para la gestión de miembros en el gimnasio. " +
                        "Permite registrar, consultar, actualizar y eliminar miembros. " +
        ...
        servers = {
                ...
                @Server(
                        ...
                        url = "https://api-miembro.gimnasio.analisys.co"
                )
        },
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        .title("Microservicio Miembro - API")
                        .description("API REST completa para la gestión de miembros en el gimnasio. " +
                                "Incluye endpoints para registrar, consultar, actualizar y eliminar miembros. " +
